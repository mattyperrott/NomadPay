        ...
        <tbody>
            <tr>
                <td class="px-30 pb-24">
                    ...
                    <h2 class="text-lg">{{ optional($donationPayment->payer)->first_name .' '. optional($donationPayment->payer)->last_name }}</h2>
                </td>
            ...
            <tr>
                ...
                <td class="px-30 pb-24 align-rigt">
                    ...
                    <h2 class="text-lg">{{ moneyFormat(optional($transaction->currency)->symbol, formatNumber($donationPayment->amount, $transaction->currency_id)) }}</h2>
                </td>
            </tr>
            <tr>
    ...
    <table class="tabl-width">
        <tbody>
            ...
            <tr>
                ...
                <td class="pb-10 pl-30 align-center">
                    <p class="text-md">{{ moneyFormat(optional($transaction->currency)->symbol, formatNumber($donationPayment->amount, $transaction->currency_id)) }}</p>
                </td>
            </tr>
            <tr>
                <td class="pb-10 pl-30 align-center">
                ...
                <td class="pb-10 pl-30 align-center">
                    <p class="text-md">{{ moneyFormat(optional($transaction->currency)->symbol, formatNumber($donationPayment->charge_percentage+$donationPayment->charge_fixed, $transaction->currency_id)) }}</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="pb-10 pl-30 align-center">
                    <p class="text-md">{{ moneyFormat(optional($transaction->currency)->symbol, formatNumber($donationPayment->total, $transaction->currency_id)) }}</p>
                </td>
            </tr>
        </tbody>
    </table>
