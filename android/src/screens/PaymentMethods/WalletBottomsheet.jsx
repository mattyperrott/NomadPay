...
import { updateCurrency } from '../../features/slices/cryptoSendCurrency/cryptoSendCurrency';
...
const WalletBottomsheet = ({
  ...
  const { loading, tatumio } = useSelector(providerStatusSelector);
  ...
  const walletElements = {
    crypto_asset: [
      { method: trans('Crypto Send'), screen: CREATE_SEND_CRYPTO },
      { method: trans('Crypto Received'), screen: RECEIVED_CRYPTO },
    ],
    crypto_token: [
      { method: trans('Token Send'), screen: CREATE_SEND_CRYPTO_TOKEN },
      { method: trans('Token Received'), screen: RECEIVED_CRYPTO_TOKEN },
    ],
    crypto: [
  ...
  return (
    <CustomBottomSheet
      ...
      {loading ? (
        ...
        ((provider == 'tatumio' && tatumio !== 'Active'))
        &&
