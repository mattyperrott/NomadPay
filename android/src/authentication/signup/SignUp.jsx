        ...
        <View style={signInContainer}>
          ...
          <View style={passwordInputContainer}>
            <CustomPhoneNumberInput
              ...
              error={(!isValidNumber  && signUpInfo.phone) || (error.phone && !signUpInfo.phone)}
              isError={
                ((!isValidNumber && signUpInfo.phone) ?
                trans('This number is Invalid.') : (error.phone && !signUpInfo.phone) ? trans('This field is required.') : '')
              }/>
          </View>
          <View style={passwordInputContainer}>
            <CustomInput
