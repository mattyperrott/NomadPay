const dynamicText = [
  ...
  trans('The minimum amount must be'),
  trans('Minimum {{ x }} {{ y }} amount needed for network fee.'),
  trans('Token info not Valid'),
  trans('Unprocessable Content'),
  trans('Token sent is not allowed in demo site.'),
  trans('{{ x }} crypto asset is not found'),
  trans('Insufficient Token'),
  trans('address must be a valid TRON address. TRON address must start with T and must contain 33 characters after. '),
  trans('You can not send to your own address'),
];
