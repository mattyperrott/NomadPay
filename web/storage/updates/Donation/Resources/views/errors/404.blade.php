...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('Modules/Donation/Resources/assets/css/404.min.css') }}">
...
<body>
    <div class="position-relative vh-100 log-bg d-flex flex-column align-items-center pb-11 overflow-auto">
        ...
        <div class="mt-14 relative flex flex-col items-center">
            ...
            <p class="error-message text-center gilroy-medium">{{ __('The page you’re looking for appears to have been moved, deleted or doesn’t exist. We apologize for the inconveniences.') }}</p>
