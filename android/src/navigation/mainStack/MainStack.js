...
import {
  ...
  SUCCESS_SEND_CRYPTO_TOKEN,
  RECEIVED_CRYPTO_TOKEN,
...
import CreateSendCryptoToken from '../../screens/SendCryptoToken/CreateSendCryptoToken/CreateSendCryptoToken';
import ConfirmSendCryptoToken from '../../screens/SendCryptoToken/ConfirmSendCryptoToken/ConfirmSendCryptoToken';
import SuccessSendCryptoToken from '../../screens/SendCryptoToken/SuccessSendCryptoToken/SuccessSendCryptoToken';
import ReceivedCryptoToken from '../../screens/ReceivedCryptoToken/ReceivedCryptoToken';
...
const MainStack = () => {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Group>
        <Stack.Screen name={CREATE_SEND_CRYPTO_TOKEN} options={{ title: trans('Send Crypto Token') }}>
          {props => (
            <PrivateRoute>
              <CreateSendCryptoToken {...props} />
            </PrivateRoute>
          )}
        </Stack.Screen>
        <Stack.Screen name={CONFIRM_SEND_CRYPTO_TOKEN} options={{ title: trans('Send Crypto Token') }}>
          {props => (
            <PrivateRoute>
              <ConfirmSendCryptoToken {...props} />
            </PrivateRoute>
          )}
        </Stack.Screen>
        <Stack.Screen name={SUCCESS_SEND_CRYPTO_TOKEN} options={{ headerShown: false }}>
          {props => (
            <PrivateRoute>
              <SuccessSendCryptoToken {...props} />
            </PrivateRoute>
          )}
        </Stack.Screen>
      </Stack.Group>
      <Stack.Group>
        <Stack.Screen name={RECEIVED_CRYPTO_TOKEN} options={{ title: trans('Received Crypto Token') }}>
          {props => (
            <PrivateRoute>
              <ReceivedCryptoToken {...props} />
            </PrivateRoute>
          )}
        </Stack.Screen>
      </Stack.Group>
